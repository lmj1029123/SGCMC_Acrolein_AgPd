...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(double * *, double * *, double * *, int *, int, int *, int, int * *, double * *, int, double * *, double * *, double * *, int *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 16), // double * *
...
/* 16 */ _CFFI_OP(_CFFI_OP_POINTER, 17), // double *
/* 17 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14), // double
};

static int _cffi_d_calculate_sf(double * * x0, double * * x1, double * * x2, int * x3, int x4, int * x5, int x6, int * * x7, double * * x8, int x9, double * * x10, double * * x11, double * * x12, int * x13)
{
  return calculate_sf(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_calculate_sf(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "calculate_sf", 14, 14, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12, &arg13))
    return NULL;
  ...
  if (datasize != 0) {
    ...
    if (_cffi_convert_array_from_object((char *)x13, _cffi_type(4), arg13) < 0)
      return NULL;
  }

  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = calculate_sf(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13); }
  _cffi_save_errno();
